    ...
    return (
        <React.Fragment>
            <TableRow
                ...
                <TableCell align="center" className="tableCell">{row?.title}</TableCell>
                <TableCell align="center" className="tableCell">{row?.activeSince && dateConversion(row?.activeSince)}</TableCell>
                ...
                <Table aria-label="collapsible table">
                    <TableHead className="tableHead">
                        <TableRow>
                            ...
                            <TableCell align="center" className="tableCell">No. of Applications</TableCell>
