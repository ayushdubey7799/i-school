...
const EmpApplicationCandidatesList = ({ page, setPage }) => {
    ...
    useEffect(() => {
        const getData = async () => {
            const res = await getJobApplicationsByJdId(page.jdId, accessToken, clientCode, 1, 10000);
            setTotal(res?.data?.total);
        ...
        <Content>
            <TableContainer component={Paper} className="tableBox">
                <div className="titleBox">
                    <span className="title">Application Lists for JD ID:- {page.jdId.toUpperCase()}</span>
                ...
                <Table aria-label="collapsible table">
                    <TableHead className="tableHead">
                        <TableRow>
                            ...
                            <TableCell align="center" className="tableCell">View Resume</TableCell>
