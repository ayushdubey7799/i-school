...
import ReqAgencyMetrics from "../components/Interviews/ReqAgencyDashboard/ReqAgencyMetrics";
import ReqAgencySidebar from "../components/Interviews/ReqAgencyDashboard/ReqAgencySidebar";
import ReqAgencyProfile from "../components/Interviews/ReqAgencyDashboard/sidebarPages/ReqAgencyProfile";
    ...
    return (
        <MainBox>
            ...
            <StyledContent>
                ...
                />
                <MainContent>
                    <ReqAgencyMetrics setCurrentItem={setCurrentItem} />
                    ...
                    {currentItem === "profile" && <ReqAgencyProfile />}
...
export default ReqAgencyDashboard;
